...
const seoCompletedGraphRunDetail = {
          ...
          nodes: [
            {
              ...
              onSuccess: "finalizeOutputs",
            },
            {
              id: "finalizeOutputs",
              kind: "script",
              outputArtifact: "finalOutputManifest",
              nodes: [
                {
                  id: "writeArticle",
                  kind: "artifactWrite",
                  artifact: "finalArticle",
  ...
  queue: [
    ...
    {
      schemaVersion: 1,
      queueEntryId: "queue-write-article",
      runId: "graph-run-seo-completed",
      nodeId: "writeArticle",
      nodePath: "writeArticle",
      nodeKind: "artifactWrite",
      status: "succeeded",
      dependsOn: ["queue-final-article"],
      producesArtifacts: [],
      ...
      updatedAt: "2026-05-18T12:32:45.000Z",
      completedAt: "2026-05-18T12:32:45.000Z",
    },
  ],
  branchItems: [],
  artifacts: [
