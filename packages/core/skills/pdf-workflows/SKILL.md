---
name: pdf-workflows
description: Inspect, extract, render, transform, validate, and package PDF-based business artifacts.
---
...
8. Treat OCR-derived content as lower-confidence than a text layer. Label OCR content when OCR tools become available.
9. Preserve originals. PDF mutation tools must create new output files and report provenance.
10. For review, flag missing pages, unreadable scans, inconsistent numbers, redaction risks, signature status, and terms that require legal or finance review.
