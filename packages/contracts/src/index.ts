...
export const TaskPlaybookImportedEventSchema = TaskEventBase.extend({
  type: z.literal("task.playbook_imported"),
  playbookId: SafePlaybookIdSchema,
  import: GraphPlaybookImportResultSchema,
  packagePath: z.string().min(1).optional(),
  versionBumpedFrom: z.string().min(1).optional(),
});
...
export const TaskEventSchema = z.discriminatedUnion("type", [
  ...
  TaskPlaybookImportedEventSchema,
...
> = {
  read_only: {
    ...
    capabilities: [
      ...
      "Inspect Tessera playbook run diagnostics",
  ...
  workspace_editor: {
    ...
    capabilities: [
      ...
      "Write files",
      "Edit files",
      "Scaffold and validate Tessera playbook packages",
      "Inspect Tessera playbook run diagnostics",
      "Manage task checklist",
